    ...
    public void CheckAnswer(string checkWord)
    {
        ...
        if (line != null)
        {
            if (!line.isShown)
            {
                ...
                int word = CPlayerPrefs.GetInt("words_count");
                CPlayerPrefs.SetInt("words_count", word+1);
    ...
    public void HintClick()
    {
        ...
        if (ballance >= Const.HINT_COST)
        {
            ...
            if (line != null)
            {
                ...
                int value = CPlayerPrefs.GetInt("spent_coin");
                CPlayerPrefs.SetInt("spent_coin", value + Const.HINT_COST);
                CheckGameComplete();
