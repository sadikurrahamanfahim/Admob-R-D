...
public class CUtils
{
    ...
    public static void LikeFacebookPage(string faceID)
    {
        ...
        Application.OpenURL(ConfigController.Config.facebookPageID);
...
//        }
    ...
    public static void RequestBannerAd()
    {
        ...
        //#endif
        AdmobController.instance.RequestBannerAd();
    }
    ...
    public static void CloseBannerAd()
    {
        ...
        AdmobController.instance.DestroyBannerAd();
    ...
    public static IEnumerator LoadPicture(string url, Action<Texture2D> callback, int width, int height, bool useCached = true)
    {
        ...
        if (!loaded)
        {
            ...
            if (www.isDone && string.IsNullOrEmpty(www.error))
            {
                ...
                callback(texture);
                System.IO.File.WriteAllBytes(localPath, texture.EncodeToPNG());
            }
            else
            {
    ...
    public static IEnumerator CachePicture(string url, Action<bool> result)
    {
        ...
        if (www.isDone && string.IsNullOrEmpty(www.error))
        {
            System.IO.File.WriteAllBytes(localPath, ((DownloadHandlerTexture)www.downloadHandler).texture.EncodeToPNG());
